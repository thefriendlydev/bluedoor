...
if(function_exists("register_field_group"))
{
  ...
  register_field_group(array (
    ...
    'fields' => array (
      array (
        'key' => 'field_542j2fbk28pire264ec1642',
        'label' => 'Main Tagline',
        'name' => 'contact_us_main_tagline',
        'type' => 'text',
      ...
      array (
        'key' => 'field_542fjlwnfw8e274bc1643',
        'label' => 'Sub Tagline',
        'name' => 'conact_us_sub_tagline',
        'type' => 'text',
        'default_value' => '',
        'placeholder' => '',
        'prepend' => '',
      ...
      array (
        'key' => 'field_543c98d20fmlfn9dq08e2',
        'label' => 'Contact Form 7 Shortcode',
        'name' => 'contact_shortcode',
        'type' => 'text',
        'instructions' => 'Copy and paste in the contact form 7 shortcode.',
        'default_value' => '',
        'placeholder' => '',
        'prepend' => '',
        'append' => '',
